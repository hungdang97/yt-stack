...
func main() {
	log.Println("=== Facebook Downloader Starting ===")
	log.Printf("Port: %d", config.Port)
	log.Printf("Storage: %s", config.StorageDir)
	log.Printf("Extractor: %s", config.FbExtractorURL)
	...
	log.Println("  GET  /proxy/image      - Proxy Facebook images")
