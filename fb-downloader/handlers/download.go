...
func HandleDownload(c *fiber.Ctx) error {
	...
	fmt.Printf("[Facebook] Download request: %s (type=%s, os=%s)\n", req.URL, req.Type, req.OS)

	// Extract post metadata from fb-extractor
	...
	// Get thumbnail — proxy through our server to bypass Facebook CORP
