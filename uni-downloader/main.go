...
func main() {
	log.Println("=== Universal Downloader Starting ===")
	log.Printf("Port: %d", config.Port)
	log.Printf("Storage: %s", config.StorageDir)
	log.Printf("Extractor: %s", config.UniExtractorURL)
	...
	app := fiber.New(fiber.Config{
		AppName:      "Uni-Downloader",
		ServerHeader: "Uni-Downloader",
	...
	log.Println("  GET  /proxy/image      - Proxy images")
