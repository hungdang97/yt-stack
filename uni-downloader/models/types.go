...
// ============================================
// UNI-EXTRACTOR API RESPONSE
// ============================================

type UniMediaItem struct {
...
type UniExtractResponse struct {
	ID             string         `json:"id"`
	...
	Media          []UniMediaItem `json:"media"`
}

// GetVideoURL returns the best DASH video URL
func (r *UniExtractResponse) GetVideoURL() string {
...
func (r *UniExtractResponse) GetVideoProgressiveURL() string {
	for _, m := range r.Media {
...
func (r *UniExtractResponse) GetAudioURL() string {
	for _, m := range r.Media {
		if m.AudioURL != "" {
			return m.AudioURL
		}
...
func (r *UniExtractResponse) GetImageURL() string {
	for _, m := range r.Media {
		if m.DisplayURL != "" {
			return m.DisplayURL
		}
