...
// allowedHosts restricts proxy to X/Twitter CDN domains only
...
// HandleProxyImage proxies X/Twitter CDN images to bypass CORS
// GET /proxy/image?url=<encoded_x_cdn_url>
