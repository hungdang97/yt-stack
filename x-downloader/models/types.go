...
// ============================================
// X-EXTRACTOR API RESPONSE
// ============================================

type XMediaItem struct {
...
type XExtractResponse struct {
	...
	Media          []XMediaItem `json:"media"`
}

// GetVideoURL returns the best DASH video URL
func (r *XExtractResponse) GetVideoURL() string {
...
func (r *XExtractResponse) GetVideoProgressiveURL() string {
	for _, m := range r.Media {
...
func (r *XExtractResponse) GetAudioURL() string {
	for _, m := range r.Media {
		if m.AudioURL != "" {
			return m.AudioURL
		}
...
func (r *XExtractResponse) GetImageURL() string {
	for _, m := range r.Media {
		if m.DisplayURL != "" {
			return m.DisplayURL
		}
